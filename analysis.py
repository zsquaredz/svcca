...
def SVCCA(file1, file2, dim1_to_keep, dim2_to_keep):
    ...
    print("Fraction of variance explained by", 65 ,"singular vectors for input1", np.sum(s1_sq[:65])/np.sum(s1_sq))
    print("Fraction of variance explained by", 66 ,"singular vectors for input1", np.sum(s1_sq[:66])/np.sum(s1_sq))
    print("Fraction of variance explained by", 67 ,"singular vectors for input1", np.sum(s1_sq[:67])/np.sum(s1_sq))
    print("Fraction of variance explained by", 68 ,"singular vectors for input1", np.sum(s1_sq[:68])/np.sum(s1_sq))
    print("Fraction of variance explained by", 69 ,"singular vectors for input1", np.sum(s1_sq[:69])/np.sum(s1_sq))
    print("Fraction of variance explained by", 70 ,"singular vectors for input1", np.sum(s1_sq[:70])/np.sum(s1_sq))
    print("Fraction of variance explained by", 670 ,"singular vectors for input2", np.sum(s2_sq[:670])/np.sum(s2_sq))
    print("Fraction of variance explained by", 680 ,"singular vectors for input2", np.sum(s2_sq[:680])/np.sum(s2_sq))
